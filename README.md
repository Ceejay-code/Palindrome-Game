This repository contains a palindrome game application for numbers with three digits. You can access the application with the following login details: username = employee, password = 123.
